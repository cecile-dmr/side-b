...
ActiveRecord::Schema[7.2].define(version: 2025_03_20_151135) do
  ...
  add_foreign_key "matches", "vinyles", column: "vinyle1_id", on_delete: :cascade
  add_foreign_key "matches", "vinyles", column: "vinyle2_id", on_delete: :cascade
